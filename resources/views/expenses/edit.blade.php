...
<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Editar Gasto</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Editar Gasto</h1>
        <p class="text-gray-600">Completa la información para actualizar un gasto</p>
    </div>
