...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-4xl font-bold text-gray-800 mb-2">Gastos</h1>
            <p class="text-gray-600">Gestiona tu catálogo de Gastos</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-800">Lista de Gastos</h2>
            <p class="text-sm text-gray-600 mt-1">Total: {{ $expenses->total() }} Gasto(s)</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-3 py-2">
                            <div class="text-sm font-semibold text-gray-900">{{ $expense->provider->name }}</div>
                        </td>
                        <td class="px-3 py-2">
                            <div class="text-sm font-semibold text-gray-900">{{ $expense->amount_formatted }}</div>
                        </td>
                        <td class="px-3 py-2">
                            <div class="text-sm font-semibold text-gray-900">{{ $expense->concept }}</div>
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <div class="text-sm font-semibold text-gray-900">{{ $expense->date }}</div>
                        </td>
                        <td class="px-3 py-2">
                            <div class="text-sm font-semibold text-gray-900 max-w-20 truncate" title="{{ $expense->description }}">{{ $expense->description }}</div>
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('expenses.edit', $expense) }}"
                                    onclick="return confirm('¿Estás seguro de actualizar este gasto?')"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12">
                            <div class="text-center">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Comienza creando un nuevo gasto.</p>
                                <div class="mt-6">
                                    <a href="{{ route('expenses.create') }}"
