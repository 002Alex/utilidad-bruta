...
<div class="container mx-auto px-4 py-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Crear Ingreso</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Crear Ingreso</h1>
        <p class="text-gray-600">Completa la información para registrar un nuevo ingreso</p>
    </div>
    ...
    <div class="max-w-full mx-auto">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form action="{{ route('incomes.store') }}" method="POST" class="p-8">
                @csrf
