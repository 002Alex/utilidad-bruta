...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('incomes.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Editar Ingreso</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <!-- Header -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-2">Editar Ingreso</h1>
        <p class="text-gray-600">Completa la información para actualizar un ingreso</p>
    </div>
    ...
    <div class="max-w-full mx-auto">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200">
                <h2 class="text-xl font-bold text-gray-800">Información del Ingreso</h2>
            </div>

            <form action="{{ route('incomes.update', $income) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="concept"
                            id="concept"
                            value="{{ old('concept', $income->concept) }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="date"
                            id="date"
                            value="{{ old('date', $income->date_formatted) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $income->description) }}</textarea>
                        @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
